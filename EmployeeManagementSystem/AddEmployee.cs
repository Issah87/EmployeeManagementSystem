...
namespace EmployeeManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\USER\Documents\employee1.mdf;Integrated Security=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\USER\Desktop\Employee-Management-System-in-CSharp-main\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
